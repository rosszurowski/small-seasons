...
const colorString = map(
  colors,
  (val, key) => `.c-${key} { color: ${val}; }`
).join("\n");
const backgroundColorString = map(
  colors,
  (val, key) => `.bgc-${key} { background-color: ${val}; }`
).join("\n");
const sizesString = map(
  sizes,
  (val, key) => `
...
const opacityString = map(
  opacity,
  (val, key) => `.o-${getSelectorValue(val)} { opacity: ${val}; }`
).join("\n");
...
export default () => (
  <style jsx global>{`
    @font-face {
      ...
      font-weight: normal;
      font-style: normal;
      src: url("/fonts/Quadraat-Regular.woff2") format("woff2"),
        url("/fonts/Quadraat-Regular.woff") format("woff");
    }
    ...
    @font-face {
      ...
      font-weight: normal;
      font-style: italic;
      src: url("/fonts/Quadraat-RegularItalic.woff2") format("woff2"),
    ...
    @font-face {
      ...
      font-weight: bold;
      font-style: normal;
      src: url("/fonts/Quadraat-Bold.woff2") format("woff2"),
        url("/fonts/Quadraat-Bold.woff") format("woff");
    }
    ...
    @font-face {
      ...
      font-weight: bold;
      font-style: italic;
      src: url("/fonts/Quadraat-BoldItalic.woff2") format("woff2"),
        url("/fonts/Quadraat-BoldItalic.woff") format("woff");
    }
